...
////매크로 함수는 해당 위치에 값을 치환하는 느낌으로 사용되기에 괄호를 제대로 넣어줘야 원하는 결과를
////얻을 수 있습니다.
////ex) SQUARE(5) = 25
//#define COMBINE(x,y) #x "+" #y
////매개변수 계산 식에 #이 들어가는 경우 문자열입니다.
////ex) COMBINE("Banana", "Milk") -> "Banana"+"Milk"
...
////}
//
////매개변수(parameter) : 함수를 호출 할 때 넣어줄 값에 대한 표현을 진행하는 변수입니다.
////return : 함수를 종료하는 기능을 가진 제어문 키워드입니다.
////함수의 타입이 void가 아닌 상태에서 return 다음에 값이 적혀있을 경우
////함수를 호출한 위치에 그 값을 전달하는 기능도 가지고 있습니다.
...
//
////일반 함수
////함수의 리턴 타입이 void로 설계된 함수를 의미하고, 별도를 return 값을 가지지 않습니다.
